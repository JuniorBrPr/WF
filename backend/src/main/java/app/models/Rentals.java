...
@NamedQuery(name = "Rental_find_by_cabinId_and_period",
        query = "SELECT R FROM Rentals R WHERE R.cabin.id =  ?1 AND R.startDate >= ?2 AND R.endDate <= ?3")
@NamedQuery(name = "Rental_find_by_cabinId", query = "SELECT R FROM Rentals R WHERE R.cabin.id = ?1")
